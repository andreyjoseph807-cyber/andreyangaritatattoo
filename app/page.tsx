    ...
    <main className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <section
        ...
        className={`relative z-10 py-24 px-6 border-t border-zinc-900 transition-all duration-1000 ${
          visible.gallery ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        <div className="max-w-7xl mx-auto">
          ...
          {/* 🔥 FIX REAL: grid limpio sin basura */}
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-zinc-400 leading-relaxed text-lg mb-8">
              Soy Andrey Angarita, tatuador especializado en blackwork, fine line y composición conceptual.
            </p>
          </div>
      ...
      <section
        ...
        className={`relative z-10 py-32 px-6 border-t border-zinc-900 bg-zinc-950 transition-all duration-1000 ${
          visible.services ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
      ...
      <footer
        ...
        className={`relative z-10 border-t border-zinc-900 py-14 px-6 transition-all duration-1000 ${
          visible.footer ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between gap-10 items-center">

          <div>
            <img src="/logo.png" alt="Logo" className="w-20 mb-4 opacity-80" />
            <p className="text-zinc-500">Andrey Angarita Tattoo</p>
          </div>
      ...
      {selected !== null && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
          ...
          <div className="relative z-10 max-w-5xl w-full px-6">
            ...
            <button onClick={prevImage} className="absolute left-4 top-1/2 text-3xl">‹</button>
            <button onClick={nextImage} className="absolute right-4 top-1/2 text-3xl">›</button>
